...
/**
 * A service responsible for executing prompts with tracing and monitoring capabilities.
 * This class integrates with a Large Language Model (LLM), sanitizes user input,
 * manages prompt templates, and records execution traces for observability.
 *
 * @property llm The LLM service used to execute chat requests and generate responses.
 * @property registry The registry for managing and retrieving prompt templates.
 * @property sanitizer A utility to sanitize user-provided input variables to prevent injection attacks.
 * @property langfuse The service used for tracking execution traces and managing observability data.
 * @property defaultLabel The default label used for identifying prompt variants when no specific label is provided.
 */
@Service
