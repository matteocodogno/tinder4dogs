...
- [ ] 1.1 Add Liquibase, OpenTelemetry, and Actuator dependencies to pom.xml
...
- [ ] 1.2 Update application configuration for Liquibase and OpenTelemetry
...
- [ ] 3. Implement the domain model and repository
- [ ] 3.1 (P) Define domain enums and value objects
...
- [ ] 3.2 (P) Implement the IntentSession JPA entity
...
- [ ] 3.3 Implement the session repository
...
- [ ] 4. Implement session service business logic
- [ ] 4.1 Implement intent declaration with session invalidation
...
- [ ] 4.2 Implement token validation and activity tracking
...
- [ ] 4.3 Implement first-swipe recording
...
- [ ] 4.4 Implement explicit session close
...
- [ ] 5. (P) Implement the session cleanup scheduler
...
- [ ] 6. Integrate OpenTelemetry observability into the service
- [ ] 6.1 Instrument service methods as OTEL spans
...
- [ ] 6.2 Emit session lifecycle span events
...
- [ ] 6.3 Implement session aggregate metrics
...
- [ ] 7. Implement the REST controller
- [ ] 7.1 (P) Implement the intent declaration endpoint
...
- [ ] 7.2 (P) Implement the session close endpoint
...
- [ ] 8. Unit test the service layer
- [ ] 8.1 (P) Test session lifecycle business logic
...
- [ ] 8.2 (P) Test OpenTelemetry signals
...
- [ ] 9. Integration test the full session lifecycle
- [ ] 9.1 (P) Test controller endpoints end-to-end
...
- [ ] 9.2 (P) Test session expiry and cleanup job
...
- [ ] 9.3 (P) Test cross-session isolation
