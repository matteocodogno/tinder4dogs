...
- [ ] 1.1 Add `spring-boot-starter-liquibase` and OTEL dependencies to `pom.xml`
...
- [ ] 1.2 Configure Liquibase and update application settings
...
- [ ] 1.3 (P) Configure OTEL telemetry properties
...
- [ ] 2.1 (P) Define the four controlled-vocabulary enums
...
- [ ] 2.4 Implement DogPhoto JPA entity
...
- [ ] 3.1 Write SQL migration for the `breeds` reference table
...
- [ ] 3.2 Write SQL migration for the `dog_profiles` table
...
- [ ] 3.3 (P) Write SQL migration for the `dog_photos` table
...
- [ ] 3.4 (P) Write SQL migration for the temperament tags join table
...
- [ ] 4.1 (P) Implement DogProfileRepository
...
- [ ] 4.2 (P) Implement DogPhotoRepository
...
- [ ] 4.3 (P) Implement BreedRepository
...
- [ ] 5.1 (P) Implement the completeness calculator
...
- [ ] 5.2 (P) Implement the breed seeder
...
- [ ] 5.3 (P) Implement owner identity resolution
...
- [ ] 6.1 Implement profile creation
...
- [ ] 6.2 Implement profile retrieval (own view and public view)
...
- [ ] 6.4 Implement profile deletion with cascade
...
- [ ] 6.5 Implement photo management
...
- [ ] 6.6 Implement the completeness endpoint
...
- [ ] 7.1 (P) Define domain exception hierarchy
...
- [ ] 7.2 (P) Implement the global exception handler
...
- [ ] 8.1 Implement DogProfileController
...
- [ ] 8.2 Implement DogPhotoController
...
- [ ] 8.3 Instrument service layer with OTEL traces and metrics
...
- [ ] 9. Tests
- [ ] 9.1 Unit-test the completeness calculator
...
- [ ] 9.2 Unit-test DogProfileService
...
- [ ] 9.3 Integration-test the REST controllers
...
- [ ] 9.4 (P) Integration-test the repository layer
...
- [ ]* 9.5 Integration-test BreedSeeder idempotency
