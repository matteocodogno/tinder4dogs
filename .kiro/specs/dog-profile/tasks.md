...
- [ ] 1.1 Add new Maven dependencies and enable async event dispatching
...
- [ ] 1.2 Add MinIO configuration properties and local dev service
...
- [ ] 2.1 Implement the controlled breed vocabulary with automatic size derivation
...
- [ ] 2.2 Implement the temperament tag vocabulary enum
...
- [ ] 2.3 Implement the domain error hierarchy and global HTTP error handler
...
- [ ] 3.1 (P) Create the dog profile database entity
...
- [ ] 3.2 (P) Create the dog photo database entity
...
- [ ] 3.3 (P) Create the profile and photo repositories with necessary queries
...
- [ ] 4.1 (P) Define the photo storage contract and wire the MinIO client bean
...
- [ ] 4.2 (P) Implement the MinIO storage adapter with upload, delete, and failure handling
...
- [ ] 5. (P) Build the breed reference service
...
- [ ] 6.2 Implement profile retrieval
...
- [ ] 6.3 Implement profile update with async domain event emission
...
- [ ] 6.4 Implement photo attachment and detachment within the profile
...
- [ ] 6.5 Implement profile soft deletion with domain event and ownership check
...
- [ ] 6.6 Implement profile completion evaluation and status reporting
...
- [ ] 7.1 Implement the dog profile controller
...
- [ ] 7.2 Implement the dog photo controller
...
- [ ] 8. (P) Implement the photo purge background job
...
- [ ] 9. Write tests
- [ ] 9.1 (P) Write unit tests for the core domain logic
...
- [ ] 9.2 (P) Write integration tests for the profile lifecycle and photo management
...
- [ ] 9.3 Write controller slice tests for all endpoints
