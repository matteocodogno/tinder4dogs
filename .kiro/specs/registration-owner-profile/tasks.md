...
- [ ] 1.1 Add new Maven dependencies for all new capabilities
...
- [ ] 1.2 Configure application properties for all new services
  ...
  - _Requirements: 1.6, 4.1, 4.2, 4.5_

---

- [ ] 2. Database Schema & Domain Entities
- [ ] 2.1 Create Liquibase changesets for the core schema
...
- [ ] 2.2 Implement the Owner domain entity and repository
...
- [ ] 2.3 (P) Implement VerificationToken entity and repository
...
- [ ] 2.4 (P) Implement RefreshToken entity and repository
...
- [ ] 3.2 Implement authentication filter and security configuration
...
- [ ] 4. Anti-Abuse Infrastructure
  > Task 4.1 and 4.2 are independent of each other and of Tasks 2 and 3. Both can start after Task 1.

- [ ] 4.1 (P) Implement IP-based rate limiting with Fibonacci-progressive blocks
...
- [ ] 4.2 (P) Implement reCAPTCHA v3 token verification
...
- [ ] 5. Owner Registration Flow
  > Starts after Tasks 2, 3, and 4 complete. Sub-tasks 5.1 and 5.2 can run in parallel.

- [ ] 5.1 (P) Implement location resolution and coordinate precision service
...
- [ ] 5.2 (P) Implement photo validation and storage service
...
- [ ] 5.3 Implement registration orchestration and account creation
...
- [ ] 5.4 Add the registration API endpoint
...
- [ ] 6.1 (P) Implement verification token lifecycle management
...
- [ ] 6.2 (P) Implement verification email dispatch
...
- [ ] 6.3 Add email verification API endpoints
...
- [ ] 7.1 Implement login attempt structured logging
...
- [ ] 7.2 Implement authentication service and credential verification
...
- [ ] 7.3 Add login, refresh, and logout API endpoints
...
- [ ] 8.1 Implement profile retrieval and update service
...
- [ ] 8.2 Add profile management API endpoints
...
- [ ] 9.1 (P) Integration tests: registration flow and anti-abuse
...
- [ ] 9.2 (P) Integration tests: email verification lifecycle
...
- [ ] 9.3 (P) Integration tests: authentication and JWT lifecycle
...
- [ ]* 9.4 E2E tests: critical user paths
