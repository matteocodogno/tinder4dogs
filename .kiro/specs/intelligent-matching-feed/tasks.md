...
- [ ] 1.1 Enable required PostgreSQL extensions via Liquibase <!-- gh:#88 -->
...
- [ ] 1.2 Create the dog profiles table with vector column and spatial indexes <!-- gh:#89 -->
...
- [ ] 1.3 Create owner preferences, swipe interactions, and match records tables <!-- gh:#90 -->
...
- [ ] 2.1 Map the DogProfile JPA entity with all profile attributes and compatibility vector <!-- gh:#91 -->
...
- [ ] 2.2 Implement geo-filtered ANN candidate retrieval <!-- gh:#92 -->
...
- [ ] 2.3 Add profile completeness validation <!-- gh:#93 -->
...
- [ ] 3.1 (P) Map the OwnerPreferences entity with radius and geolocation consent fields <!-- gh:#94 -->
...
- [ ] 3.2 Add search radius validation and persistence <!-- gh:#95 -->
...
- [ ] 4.1 (P) Implement coordinate approximation <!-- gh:#96 -->
...
- [ ] 4.2 (P) Implement city-level fallback for owners without geolocation consent <!-- gh:#97 -->
...
- [ ] 5.1 (P) Build the rule-based fallback scorer <!-- gh:#98 -->
...
- [ ] 5.2 Build the AI compatibility scoring service <!-- gh:#99 -->
...
- [ ] 5.3 Add the compatibility scoring Langfuse prompt template <!-- gh:#100 -->
...
- [ ] 6.1 (P) Map the SwipeInteraction entity and implement idempotent swipe repository <!-- gh:#101 -->
...
- [ ] 6.2 (P) Map the MatchRecord entity and implement deduplicated match repository <!-- gh:#102 -->
...
- [ ] 7. Match service
- [ ] 7.1 Implement atomic match creation with chat channel assignment <!-- gh:#103 -->
...
- [ ] 7.2 Publish MatchCreatedEvent after successful commit <!-- gh:#104 -->
...
- [ ] 8. Swipe service
- [ ] 8.1 Implement ownership validation and swipe recording <!-- gh:#105 -->
...
- [ ] 8.2 Implement mutual match detection and delegation <!-- gh:#106 -->
...
- [ ] 9. Feed service
- [ ] 9.1 Implement the profile completeness gate <!-- gh:#107 -->
...
- [ ] 9.2 Build candidate retrieval with geo filter and exclusion set <!-- gh:#108 -->
...
- [ ] 9.3 Implement AI scoring, score merging, and pagination <!-- gh:#109 -->
...
- [ ] 10.1 (P) Expose feed retrieval and search radius endpoints <!-- gh:#110 -->
...
- [ ] 10.2 (P) Expose swipe action endpoint <!-- gh:#111 -->
...
- [ ] 11. Tests
- [ ] 11.1 Unit test core business logic <!-- gh:#112 -->
...
- [ ] 11.2 Integration test with real database (TestContainers) <!-- gh:#113 -->
...
- [ ]* 11.3 Performance baseline for feed and swipe endpoints <!-- gh:#114 -->
